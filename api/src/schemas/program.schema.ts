...
export type PostJoinProgramByAddressRequest = TypeOf<typeof postJoinProgramByAddressSchema>["body"]

export type PostCreateProgramRequest = z.infer<typeof postCreateProgramSchema>["body"]

export type GetProgramByAddressRequest = TypeOf<typeof getProgramByAddressSchema>["params"]
